...
namespace Chat\Chatbox\Helper;

class Data extends \Magento\Framework\App\Helper\AbstractHelper
{
    const FACEBOOK_MESSENGER_ENABLE = 'MeShop_Chatbox/general/facebook_messenger_enable';
    const FACEBOOK_MESSENGER_CUSTOMER_CHAT_CODE = 'MeShop_Chatbox/general/facebook_messenger_customer_chat_code';
    const TAWK_TO_WIDGET_ENABLE = 'MeShop_Chatbox/general/tawk_enable';
    const TAWK_TO_WIDGET_CODE = 'MeShop_Chatbox/general/tawk_widget_code';
